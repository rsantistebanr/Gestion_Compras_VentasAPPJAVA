...
public class Modificar_Proveedor extends javax.swing.JFrame {
    ...
    public Modificar_Proveedor(proveedor padre) {
        this.padre = padre;
        initComponents();
    ...
    private void btn_guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_guardarActionPerformed
        ...
        entidades.Proveedor oP = new entidades.Proveedor(txt_codigo.getText().toUpperCase(), txt_nombre.getText().toUpperCase(), txt_ruc.getText().toUpperCase());
        padre.oM.getTp().Actualizar(oP);
        txt_codigo.setText("");
        txt_nombre.setText("");
        txt_ruc.setText("");
